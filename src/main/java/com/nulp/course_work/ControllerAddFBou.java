...
import static com.nulp.course_work.Bouquet.addflowerFromFilteredListFX;
import static com.nulp.course_work.sortfilter.FilterflowersWithEntering.*;

public class ControllerAddFBou implements Initializable {
    ...
    public void Add(ActionEvent e)
    {
        try {
            ...
            addflowerFromFilteredListFX(index);
